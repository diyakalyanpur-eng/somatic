...
function fuseAndSave() {
  ...
  // SpO2: finger only — contact PPG is the only reliable source.
  // Face rPPG SpO2 is directional at best and intentionally excluded.
  // If the finger scan didn't produce a reading (e.g. no torch, poor coverage),
  // we show "—" rather than a low-confidence face estimate.
